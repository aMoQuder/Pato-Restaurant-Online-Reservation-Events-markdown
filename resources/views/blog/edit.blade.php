                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form action="{{ route('saveblog') }}" method="post" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="old_description" value="{{ $blog->description }}">
                            ...
                            <div class="card-style mb-30">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="input-style-1">
                                            <label>Message</label>
                                            <textarea placeholder="{{$blog->description}}" name="description" rows="5"></textarea>
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-style-1">
                                            ...
                                            <img src="{{asset('blog/img/'.$blog->image)}}" class="w-100 " id="image_preview" style="height: 220px;" alt="">
                                        </div>
